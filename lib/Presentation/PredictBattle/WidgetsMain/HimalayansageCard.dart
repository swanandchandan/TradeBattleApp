...
class HimalayanSageCard extends StatefulWidget {
  const HimalayanSageCard({super.key});

  @override
  State<HimalayanSageCard> createState() => _HimalayanSageCardState();
}

class _HimalayanSageCardState extends State<HimalayanSageCard> {
  @override
