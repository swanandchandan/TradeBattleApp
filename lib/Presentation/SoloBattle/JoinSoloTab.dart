...
import 'package:dummy_tradebattle/Presentation/SoloBattle/SoloBaseLayout.dart';
import 'package:flutter/material.dart';

class Joinsolotab extends StatefulWidget {
  const Joinsolotab({super.key});

  @override
  State<Joinsolotab> createState() => _JoinsolotabState();
}

class _JoinsolotabState extends State<Joinsolotab> {
  @override
    ...
    return SizedBox(
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const Solobaselayout()),
          );
        },
        child: Container(
