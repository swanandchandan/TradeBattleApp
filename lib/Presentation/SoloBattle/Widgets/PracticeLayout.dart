...
class Sololayout extends StatefulWidget {
  const Sololayout({super.key});

  @override
  State<Sololayout> createState() => _SololayoutState();
}

class _SololayoutState extends State<Sololayout> {
  @override
