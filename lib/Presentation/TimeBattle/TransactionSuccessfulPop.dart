...
class Transactionsuccessfulpop extends StatefulWidget {
  const Transactionsuccessfulpop({super.key});

  @override
  State<Transactionsuccessfulpop> createState() =>
      _TransactionsuccessfulpopState();
}

class _TransactionsuccessfulpopState extends State<Transactionsuccessfulpop> {
  @override
